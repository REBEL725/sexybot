...
@bot.on(admin_cmd(pattern="playlist (.*!?)"))
@bot.on(sudo_cmd(pattern="playlist(.*!?)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="skip (.*!?)"))
@bot.on(sudo_cmd(pattern="skip(.*!?)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="play (.*!?)"))
@bot.on(sudo_cmd(pattern="play (.*!?)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="pradio (.*!?)"))
@bot.on(sudo_cmd(pattern="pradio (.*!?)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="sradio (.*!?)"))
@bot.on(sudo_cmd(pattern="sradio (.*!?)", allow_sudo=True))
async def stop_radio(client, message):
 ...
 @bot.on(admin_cmd(pattern="pause (.*!?)"))
 @bot.on(sudo_cmd(pattern="pause (.*!?)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="resume (.*!?)"))
@bot.on(sudo_cmd(pattern="resume (.*!?)", allow_sudo=True))
...
@bot.on(sudo_cmd(pattern="stopvc (.*!?)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="rvc (.*!?)"))
@bot.on(sudo_cmd(pattern="rvc (.*!?)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="rjvc (.*!?)"))
@bot.on(sudo_cmd(pattern="rjvc (.*!?)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="leavevc (.*!?)"))
@bot.on(sudo_cmd(pattern="leavevc (.*!?)", allow_sudo=True))
...
@bot.on(admin_cmd(pattern="setvolvc (.*!?)"))
@bot.on(sudo_cmd(pattern="setvolvc (.*!?)", allow_sudo=True))
